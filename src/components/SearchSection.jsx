    ...
    backgroundColor: color.bgColor1
      ...
      <View className="flex flex-row items-center justify-between gap-2 w-full">
        <View className="w-9 h-9">
          <Image source={require("../../assets/image/brand.png")} className="w-full h-full" />
        </View>
        <View className="relative w-[250px]">
          ...
          fontSize: 14
        }} className="rounded-lg p-1 pl-3" placeholder="Search Surah..." multiline={false} value={searchTerm} placeholderTextColor={color.txtColor} onChangeText={value => search(value)}></TextInput>
        ...
        <View>
          <Pressable>
            {isDark ? <View>
                <IonicIcon name="moon-sharp" solid size={30} style={{
              ...
              toggleTheme();
                ...
                <IonicIcon name="sunny" solid size={30} style={{
              color: color.activeIconColor
            }} onPress={() => {
              vibrate();
              toggleTheme();
