...
const NobleQuranTab = memo(() => {
  ...
  return <Tab.Navigator initialRouteName="Home" screenOptions={{
    ...
    tabBarStyle: {
      ...
      <Tab.Screen name="SingleSurah" component={SingleSurah} options={{
      tabBarIcon: ({
        _color,
        focused
      }) => {
      ...
      tabBarIcon: ({
        ...
        return <Ionicon name="settings" size={20} color={focused ? color.activeIconColor : color.txtColor} />;
      },
      tabBarShowLabel: false
    }} />
    </Tab.Navigator>;
