...
import { Image, ImageBackground, ScrollView, View, ToastAndroid, Text } from "react-native";
...
const SingleSurah = memo(() => {
  ...
  const {
    ...
    loading,
    tafsir
  } = useSelector(state => state.fullSurah);
  const {
    surah,
    surahDetails
  } = fullSurahWithDetails;
  ...
  const showToast = (title1 = "Something went wrong.") => {
    ToastAndroid.showWithGravityAndOffset(title1, ToastAndroid.SHORT, ToastAndroid.BOTTOM, 25, 50);
  };
  const copyToClipboard = useCallback(async ayah => {
    vibrate();
    await Clipboard.setStringAsync(`
    ${surah.verses[ayah - 1].arabic_text} ${surah.verses[ayah - 1].bangl_text} ${surah.verses[ayah - 1].english_text} সূরা - ${surahDetails.enTranslatedName} আয়াত - ${convertToBanglaNumber(ayah.toString())}
    `);
  ...
  return <View style={{
    flex: 1
  }} className="relative" key={uniqueKey}>
      <View style={{
      backgroundColor: color.bgColor1
    }} className="flex flex-row items-center justify-between">
        <View>
          <IconButton icon={props => <Ionicon name="arrow-back-outline" {...props} size={30} color={color.txtColor} />} onPress={() => {
          vibrate();
          ...
          {!loading && <>
              ...
              <View className="flex items-center">
                <View className="flex flex-row gap-2">
                  ...
                  {readLater[surah.id] && <View className="flex flex-row items-center">
                      <CustomText className="text-xs font-bold" style={{
        ...
        <View>
          <IconButton icon={props => <Ionicon name="settings-outline" {...props} size={22} color={color.txtColor} />} onPress={() => {
          vibrate();
          setSettingBox(true);
        }} />
        </View>
      ...
      backgroundColor: color.bgColor2
        ...
        {loading ? <View className="w-full h-full flex items-center justify-center">
            <View className="w-6 h-6 flex flex-row items-center">
              <Image className="w-full h-full" source={require("../../assets/image/loading.gif")} />
            </View>
          </View> : <>
            <View style={{
          flex: 1
            ...
            width: "100%"
                ...
                <FlashList ref={listRef} data={surah.verses} initialScrollIndex={currentAyah - 1} renderItem={({
              item
            }) => {
              const {
                id,
              ...
              return <View style={{
                paddingBottom: id === surahDetails.totalAyah ? height / 2 : 0
              }}>
                        {surah.id !== 1 && id === 1 && <>
                            <View className="flex items-center my-1">
                              <View className="h-10 w-[60%]">
                                {isDark ? <ImageBackground source={require("../../assets/image/bismillah-white.png")} className="h-full w-full object-cover" /> : <ImageBackground source={require("../../assets/image/bismillah-black.png")} className="h-full w-full object-cover" />}
                              </View>
                            </View>
                          </>}
                  ...
                  backgroundColor: color.bgColor1
                          ...
                          <View className="flex flex-row justify-center">
                            <CustomButton uniqueColor={true} title={`আয়াত-${convertToBanglaNumber(id.toString())}`} />
                            <AhayDetails page={page} juz={juz} ruku={ruku} manzil={manzil} />
                          </View>
                          ...
                          marginTop: 5
                                    ...
                                    <Ionicon name="checkmark-circle" size={13} color={color.activeIconColor} className="mr-1" />
                            ...
                            <SavedAyahbutton surahNumber={surah.id} ayahNumber={id} />
                          </View>
                        </View>

                        <View className="p-3">
                          <CustomText className="mt-1">
                            <TajweedVerse verse={colorText} config={{
                      color: color.txtColor
                        ...
                        <ButtonAction copyToClipboard={copyToClipboard} id={id} surahNumber={surah.id} tafsir={tafsir} setTafsirModal={setTafsirModal} />
                      </View>;
            }} estimatedItemSize={400} onViewableItemsChanged={onViewableItemsChanged} />
              </View>
            </View>
          </>}
      </View>
      <View className={`absolute z-30 top-0 right-0 w-full h-full flex items-center justify-center ${tafsirModal ? "block" : "hidden"}`} style={{
      flex: 1,
      backgroundColor: "rgba(0, 0, 0, 0.5)"
    }}>
        <View className="w-[90%] h-[90%] p-2 rounded-lg" style={{
        backgroundColor: color.bgColor2
      }}>
          <CustomText className="text-lg" style={[{
          ...
          <View className="h-[87%]">
            ...
            }} systemFonts={systemFonts} tagsStyles={{
              p: {
                color: color.txtColor,
                fontFamily: "banglar",
      ...
      {settingBox && <View className={`absolute top-0 right-0 w-full h-full flex items-center z-20`} style={{
      flex: 1,
      backgroundColor: "rgba(0, 0, 0, 0.5)"
    }}>
          <View className="w-[90%] py-2 rounded-lg mt-2" style={{
        backgroundColor: color.bgColor2
      }}>
            <ScrollView style={{
          maxHeight: height / 3
      ...
      {!loading && <>
          {isShowAudioPlayer && <>
              <View className={`absolute ${audioPlayer ? "bottom-[0]" : "bottom-[-175]"} right-0 w-full py-2`} style={{
          backgroundColor: color.bgColor1,
          borderTopWidth: 6,
          borderColor: color.activeIconColor,
          borderRadius: 10,
          ...
          borderBottomWidth: 0.0001
                ...
                <View className="w-full absolute top-[-20] flex items-center justify-center z-10">
                  <View className="w-8 h-8 rounded-full" style={{
              backgroundColor: color.bgColor2,
              borderWidth: 2,
              borderColor: color.activeIconColor,
              overflow: "hidden"
              ...
              }} className="flex items-center justify-center" onPress={() => {
                vibrate();
                setAudioPlayer(!audioPlayer);
              }}>
                      <Ionicon name="chevron-up-outline" size={22} color={color.activeIconColor} className={`${audioPlayer ? "rotate-180" : "rotate-0"}`} />
                    </Pressable>
                  </View>
                </View>
                ...
                height: 40
                  ...
                  if (currentAyah > 1) {
                    setCurrentAyah(currentAyah - 1);
                        ...
                        <Ionicon name="play-back" size={28} color={color.activeIconColor} className="mr-1" />
                      </Pressable>
                    </View>
                    {isDownloadedSurah ? <View>
                        {isPlaySurah ? <View className="rounded-full overflow-hidden" style={{
                  width: 40,
                  height: 40
                }}>
                            <Pressable className="" style={{
                    ...
                    if (soundObject) {
                      await soundObject.pauseAsync();
                              ...
                              <Ionicon name="pause" size={28} color={color.activeIconColor} />
                            </Pressable>
                          </View> : <View className="rounded-full overflow-hidden" style={{
                  width: 40,
                  height: 40
                }}>
                            <Pressable className="" style={{
                    ...
                    setIsPlaySurah(true);
                              ...
                              <Ionicon name="play" size={28} color={color.activeIconColor} className="ml-1" />
                            </Pressable>
                          </View>}
                      </View> : <View>
                        <View className="rounded-full overflow-hidden" style={{
                  ...
                  height: 40
                    ...
                    setDownloadWarningModal(true);
                            ...
                            <FontAwesome name="download" size={23} color={color.activeIconColor} />
                          </Pressable>
                        </View>
                      </View>}
                    <View className="rounded-full overflow-hidden" style={{
                ...
                height: 40
                  ...
                  goToForward();
                        ...
                        <Ionicon name="play-forward" size={28} color={color.activeIconColor} className="ml-1" />
                      </Pressable>
                    </View>
                  </View>
                </View>
                <>
                  <View className="w-full flex flex-row items-center justify-between px-2">
                    <CustomText className="font-bold" style={[{
                color: color.activeIconColor
              }]}>
                ...
                color: color.activeIconColor
                  ...
                  <View className="px-2">
                    <Slider value={currentAyah} minimumValue={1} maximumTrackTintColor={color.maximumTintColor} minimumTrackTintColor={color.activeIconColor} maximumValue={surahDetails.totalAyah} thumbStyle={{
              ...
              setPlayFullSurah(!playFullSurah);
                ...
                }} value={playFullSurah} onValueChange={() => setPlayFullSurah(!playFullSurah)} color={color.activeIconColor} />
                    </View>
                  </Pressable>
                </View>
                <Pressable style={{
            ...
            pickerRef.current.focus();
              ...
              fontWeight: "bold"
                  ...
                  <View>
                    <View className="flex flex-row items-center justify-between" style={{
                borderWidth: 2,
                borderColor: color.activeIconColor,
                paddingRight: 7,
                height: 30,
                ...
                backgroundColor: color.bgColor1
                      ...
                      <Picker ref={pickerRef} style={{
                  width: 40
                }} selectedValue={repeatAyah} onValueChange={itemValue => setRepeatAyah(+itemValue)} dropdownIconColor={color.activeIconColor}>
                        <Picker.Item style={{
                    color: color.txtColor,
                    backgroundColor: color.bgColor2
                  }} label="একটা নির্বাচন করুন" />
                        {data.map(item => <Picker.Item style={{
                    color: color.txtColor,
                    backgroundColor: color.bgColor2
                  }} label={item.toString()} value={item.toString()} key={item.toString()} />)}
                      </Picker>
                      <CustomText style={[banglaFont.banglaR, {
                  fontWeight: "bold",
                  color: color.activeIconColor
              ...
              <>
                <View className={`absolute top-0 right-0 w-full h-full flex items-center justify-center ${downloadWarningModal ? "block" : "hidden"}`} style={{
            flex: 1,
            backgroundColor: "rgba(0, 0, 0, 0.5)"
          }}>
                  <View className="w-[90%] h-[30%] p-2 rounded-lg" style={{
              backgroundColor: color.bgColor2
            }}>
                    <CustomText className="text-lg" style={[{
                borderBottomWidth: 0.3,
              ...
              <>
                <View className={`absolute top-0 right-0 w-full h-full flex items-center justify-center ${downloadModal ? "block" : "hidden"}`} style={{
            flex: 1,
            backgroundColor: "rgba(0, 0, 0, 0.5)"
          }}>
                  <View className="w-[90%] h-[150] p-2 rounded-lg" style={{
              backgroundColor: color.bgColor2
            }}>
                    <CustomText className="text-lg" style={[{
                borderBottomWidth: 0.3,
                ...
                marginBottom: 5
                    ...
                    <View className="">
                      ...
                      color: color.activeIconColor
                            ...
                            {convertToBanglaNumber(numDownloadedFiles.toString())}
                          </CustomText>
                          <CustomText className="font-bold" style={[{
                      color: color.activeIconColor
                    }]}>
                        ...
                        <View className="px-2">
                          <Slider value={numDownloadedFiles} minimumValue={1} maximumTrackTintColor={color.maximumTintColor} minimumTrackTintColor={color.activeIconColor} maximumValue={surahDetails.totalAyah} thumbStyle={{
                      backgroundColor: color.activeIconColor
                    }} thumbTouchSize={{
                      width: 50,
                      height: 50
